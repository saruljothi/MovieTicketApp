...
public class UserValidator implements Validator {
  ...
  public void validate(Object o, Errors errors) {
    ...
    ValidationUtils.rejectIfEmptyOrWhitespace(errors, "emailId", "Email field should not be empty.");
    ...
    ValidationUtils.rejectIfEmptyOrWhitespace(errors, "password", "Password field should not be empty.");
    if(userProfile.getPassword().length() < 8){
      errors.rejectValue("password", "Password should be at least 8 characters.");
    }

    ValidationUtils.rejectIfEmptyOrWhitespace(errors, "passwordConfirmation", "Password confirmation field should not be empty.");
